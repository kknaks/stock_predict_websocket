"""
KRX 가격 WebSocket Client

KRX(한국거래소) 실시간 가격 정보 수신
"""

from app.kis.websocket.price_client import BasePriceWebSocketClient


class KrxPriceClient(BasePriceWebSocketClient):
    """KRX 가격 웹소켓 클라이언트"""

    exchange_type = "KRX"
    exchange_label = "KRX"

    # H0STCNT0 체결가 컬럼 (46개 - KIS 공식 스펙)
    PRICE_COLUMNS = [
    ...
    price_tr_id = "H0STCNT0"
    asking_tr_id = "H0STASP0"
